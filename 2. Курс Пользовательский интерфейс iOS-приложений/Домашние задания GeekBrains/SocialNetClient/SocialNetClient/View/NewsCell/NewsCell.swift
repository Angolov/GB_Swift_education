...
final class NewsCell: UITableViewCell {
    ...
    lazy private var photosCollectionView: NewsPhotoCollectionView = {
        ...
        var collectionView = NewsPhotoCollectionView(frame: CGRect(x: 0,
                                                                   y: 0,
    ...
    private func setupView() {
        ...
        photosCollectionView.heightAnchor.constraint(equalToConstant: heigthForPhotoCollectionView).isActive = true

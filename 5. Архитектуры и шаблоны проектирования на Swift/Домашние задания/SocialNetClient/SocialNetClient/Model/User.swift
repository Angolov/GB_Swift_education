...
//MARK: - UserFriend class declaration

class UserFriend: UserProtocol {
    var userId: Int
    var name: String
    var avatarImageName: String
    
    init(_ vkFriend: VKUserFriend) {
        self.userId = vkFriend.userId
        self.name = vkFriend.name
        self.avatarImageName = vkFriend.avatarImageName
    }
}
